    ...
    <div>
      <form onSubmit={handleSubmit}>
        <div>
              ...
              <Field name="level.Beginner" id="Beginner" component="input" type="checkbox"  />
              <label className="ml-5"> Advanced </label>
              <Field name="level.Advanced" id="Advanced" component="input" type="checkbox"  />
              <label className="ml-5"> Expert </label>
              <Field name="level.Expert" id="Expert" component="input" type="checkbox"  />
              </div>
              <label  className="topTitle" >Select the index of destination</label>
              <div>
              <label> Category 1: to 4.4</label>
              <Field name="category.Category1" id="Category1" component="input" type="checkbox"  />
              <label className="ml-5"> Category 2: from 4.4 to 11.4 </label>
              <Field name="category.Category2" id="Category2" component="input" type="checkbox"  />
              <label className="ml-5"> Category 3: from 11.4 to 18.4 </label>
              <Field name="category.Category3" id="Category 3" component="input" type="checkbox"  />
              <label className="ml-5"> Category 4: from 18.4 to 26.4 </label>
              <Field name="category.Category4" id="Category4" component="input" type="checkbox"  />
              <label className="ml-5"> Category 5: from 26.4 to 36 </label>
              <Field name="category.Category5" id="Category5" component="input" type="checkbox"  />
              <label className="ml-5"> Category 6: from 36 to 54 </label>
              <Field name="category.Category6" id="Category6" component="input" type="checkbox"  />
              </div>
              <label  className="topTitle" >Select the weather of destination</label>
              <div>
              <label> Rain </label>
              <Field name="weather.Rain" id="Rain" component="input" type="checkbox"  />
              <label className="ml-5"> Cold </label>
              <Field name="weather.Cold" id="Cold" component="input" type="checkbox"  />
              <label className="ml-5"> Mild </label>
              <Field name="weather.Mild" id="Mild" component="input" type="checkbox"  />
              <label className="ml-5"> Sunny </label>
              <Field name="weather.Sunny" id="Sunny" component="input" type="checkbox"  />
              </div>
